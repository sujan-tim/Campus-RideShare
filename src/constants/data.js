...
export const MOCK_RIDE_REQUESTS = [
  {
    ...
    rider: 'Nina Patel',
    initials: 'NP',
    from: 'Busch Student Center',
    to: 'College Avenue Student Center',
    fromCampusId: 'busch',
    toCampusId: 'college_ave',
    pickupSpot: 'Busch Student Center',
    dropoffSpot: 'The Yard',
    eta: 'Pickup in 5 min',
    fare: '$5',
    distance: '2.8 mi',
    riderPhone: '+17325550121',
    note: 'Waiting by the front bus stop.',
    status: 'pending',
  },
  {
    id: 'rq2',
    rider: 'Owen Kim',
    initials: 'OK',
    from: 'Livingston Quads',
    to: 'Werblin Recreation Center',
    fromCampusId: 'livingston',
    toCampusId: 'busch',
    pickupSpot: 'Livingston Quads',
    dropoffSpot: 'Werblin Recreation Center',
    eta: 'Pickup in 7 min',
    fare: '$5',
    distance: '2.1 mi',
    riderPhone: '+17325550122',
    note: 'Blue backpack, near the main entrance.',
    status: 'pending',
  },
  {
    id: 'rq3',
    rider: 'Sara Lopez',
    initials: 'SL',
    from: 'Douglass Library',
    to: 'The Yard',
    fromCampusId: 'douglass',
    toCampusId: 'college_ave',
    pickupSpot: 'Douglass Library',
    dropoffSpot: 'The Yard',
    eta: 'Pickup in 4 min',
    fare: '$5',
    distance: '1.9 mi',
    riderPhone: '+17325550123',
